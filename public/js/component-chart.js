                ...
                $.each(country_data, (index, row) => {
                    ...
                    switch (index) {
                        case 'equivalent-gasoline-e0':
                            ...
                            $(idSel === 'chart-tab-components' ? '#chart-tab-e0-ron-data' : '#chart-tab-e0-ron-data-compare').html(parseFloat(row.component['ron']).toFixed(1));
                            $(idSel === 'chart-accordion-components' ? '#chart-accordion-e0-ron-data' : '#chart-accordion-e0-ron-data-compare').html(parseFloat(row.component['ron']).toFixed(1));
                            break;
                        case 'gasoline-e10':
                            ...
                            $(idSel === 'chart-tab-components' ? '#chart-tab-e10-ron-data' : '#chart-tab-e10-ron-data-compare').html(parseFloat(row.component['ron']).toFixed(1));
                            $(idSel === 'chart-accordion-components' ? '#chart-accordion-e10-ron-data' : '#chart-accordion-e10-ron-data-compare').html(parseFloat(row.component['ron']).toFixed(1));
                            break;
                        case 'gasoline-e15':
                            ...
                            $(idSel === 'chart-tab-components' ? '#chart-tab-e15-ron-data' : '#chart-tab-e15-ron-data-compare').html(parseFloat(row.component['ron']).toFixed(1));
                            $(idSel === 'chart-accordion-components' ? '#chart-accordion-e15-ron-data' : '#chart-accordion-e15-ron-data-compare').html(parseFloat(row.component['ron']).toFixed(1));
                            break;
                        case 'gasoline-e20':
                            ...
                            $(idSel === 'chart-tab-components' ? '#chart-tab-e20-ron-data' : '#chart-tab-e20-ron-data-compare').html(parseFloat(row.component['ron']).toFixed(1));
                            $(idSel === 'chart-accordion-components' ? '#chart-accordion-e20-ron-data' : '#chart-accordion-e20-ron-data-compare').html(parseFloat(row.component['ron']).toFixed(1));
                            break;
                        case 'gasoline-e25':
                            ...
                            $(idSel === 'chart-tab-components' ? '#chart-tab-e25-ron-data' : '#chart-tab-e25-ron-data-compare').html(parseFloat(row.component['ron']).toFixed(1));
                            $(idSel === 'chart-accordion-components' ? '#chart-accordion-e25-ron-data' : '#chart-accordion-e25-ron-data-compare').html(parseFloat(row.component['ron']).toFixed(1));
                            break;
                        case 'gasoline-e30':
                            ...
                            $(idSel === 'chart-tab-components' ? '#chart-tab-e30-ron-data' : '#chart-tab-e30-ron-data-compare').html(parseFloat(row.component['ron']).toFixed(1));
                            $(idSel === 'chart-accordion-components' ? '#chart-accordion-e30-ron-data' : '#chart-accordion-e30-ron-data-compare').html(parseFloat(row.component['ron']).toFixed(1));
                            break;
                    }
                });
                const compsTD = [];
