...
return [
    ...
    'content' => [ 
        ...
        'select-country-text' => 'Select the country you want to analyze.  Once selected, scroll through the three available tabs to observe country-specific information, and compare to other countries or regions.',
        ...
        'component-tab' => [
            ...
            'benefits-5' => 'The advantages of ethanol are numerous; it is made from renewable sources, boosts octane and dilutes sulfur in fuel, and helps to fulfill environmental and climate targets.',
            ...
            'benefits-list-element-3' => 'Quality parameters by country',
            ...
            'instructions-4' => 'By placing the mouse cursor over the bars in the chart, you can see the percentages of the components in the gasoline for the selected countries; the top of the chart shows production costs for each fuel blend.',
        ...
        'impact-tab' => [
            'model-reference' => 'The model used in this analysis is built using the ',
            'model-link-text' => 'International Vehicle Emissions Model (IVE).',
            'model-reference_2' => ' as a reference.',
            'model-rates' => 'The model uses the Base Emission Rates from the IVE model, as well as its Adjustment Factors based on:',
            'model-rates-p-1' => 'Vehicle technology (cars, trucks, buses, motorcycles)',
            'model-rates-p-2' => 'Vehicle fleet average age',
            'model-rates-p-3' => 'Average traveled distance per vehicle by country, average distance traveled',
            'model-rates-p-4' => 'Geographical and climatic conditions (altitude, humidity, temperature)',
            'calculate-emissions' => 'Emissions of criteria pollutants, toxic pollutants, and greenhouse gases (GHG) were calculated and calibrated with emission inventories, using real gasoline quality data. The reduction rates for gasoline/ethanol blends were obtained from various sources (IPCC, USGBC, among others).',
            ...
            'instructions-2' => 'In the United States, 70% of vehicles are light duty vehicles, 22% light duty trucks, 3% motorcycles, and 5% heavy duty vehicles. Some Latin American countries have lower pollutant emissions compared to the  United States. This is mainly due to differences in the vehicle fleets in these countries, where there may be greater numbers of motorcycles, cars and trucks, and fewer trucks and heavy vehicles. Pollutant emissions are also determined  by the type of vehicle, technology, age, emission standards and the number of vehicles in each country.',
            'compare-select' => 'Select',
            'co2' => 'CARBON DIOXIDE',
            'thc' => 'VOLATILE ORGANIC COMPOUNDS',
            'co' => 'CARBON MONOXIDE',
            'pm' => 'PARTICULATE MATTER',
            'nox' => 'NITROGEN OXIDE',
            'btx' => 'AROMATICS',
            'graph-title-co2' => 'Carbon dioxide (CO2) emissions in grams per km',
            'graph-title-thc' => 'Volatile Organic Compounds (VOC) emissions in grams per km',
    ...
    'table-texts' => [
        ...
        'header-rvp' => 'RVP 37.8 °C',
        'header-overall-biofuels' => 'Overall Biofuels (%cal)',
        'header-advanced-biofuel-gasoline' => 'Advanced Biofuel Gasoline Sales (%cal)',
        'header-bioethanol-gasoline-sales' => 'Bioethanol  Gasoline Sales (%cal)',
        'header-ghg-emission-reduction' => 'GHG emission reduction (%)',
    ],
    'images' => [
    ...
    'pdf-files' => [
        ...
        'profile-asia-africa-pdf-filename' => 'profiles_asia_download.xlsx',
        'component-europe-pdf-filename' => 'blending_europe_components.xlsx',
        'component-asia-africa-pdf-filename' => 'blending_asia_components.xlsx',
        'emission-europe-filename' => 'emissions_europe_download.xlsx',
        'emission-asia-africa-filename' => 'emissions_asia_download.xlsx',
        'ghg-europe-filename' => 'ghg_europe_download.xlsx',
        'ghg-asia-africa-filename' => 'ghg_asia_download.xlsx',
    ],
];
