                        ...
                        <div class="back-blue text-center">
                            ...
                            <div style="display: flex; justify-content: flex-end;">
                                ...
                                ">
                                    ...
                                    justify-content: center;
                                ">
                                        <img src="{{ asset('images/map-global-en.png') }}" alt="America" width="40">
                                    </a>
                                </div>
                            </div>
                            <input type="hidden" class="form-control" id="user_locale_hidden"
                                aria-label="user_locale_hidden" aria-describedby="user_locale_hidden"
                                value="{{ app()->getLocale() }}">

                            <h2 class="h1 uppercase md:text-5xl"><a href="{{ route(__('routes.home')) }}"
                                    class="text-white">{{ __('dynamic.content.profiles') }}</a></h2>

                            <label id="tool_continent" class="text-white mt-0 pt-0 oswald" aria-label="tool_continent"
                                aria-describedby="tool_continent">
                                @if (isset($continent_text))
                                    {{ $continent_text }}
                                @endif
                            </label>
                            ...
                            <div class="dynamic-flex-area md:flex flex-wrap justify-center text-shadow">
                                <a href="#" id="switch_continent_america"
                                    class="flex-1 mg-button mg-button--larger mg-button--tertiary mx-4 p-3 flex  items-center text-base md:text-lg lg:text-3xl "
                                ...
                                <a href="#" id="switch_continent_asia_africa"
                                    class="flex-1 mg-button mg-button--larger mg-button--tertiary mx-4 p-3 flex  items-center text-base md:text-lg lg:text-3xl "
                                    style="flex-direction: column;">
                                    <div class="mx-auto w-100">
                                        <img src="{{ asset('images/map-asia-en.png') }}" alt=""
                                            class="hero-sec-img">
                                ...
                                <a href="#" id="switch_continent_europe"
                                    class="flex-1 mg-button mg-button--larger mg-button--tertiary mx-4 p-3 flex  items-center text-base md:text-lg lg:text-3xl "
                                    style="flex-direction: column;">
                                    <div class="mx-auto w-100">
                                        <img src="{{ asset('images/map-europe-en.png') }}" alt=""
                                            class="hero-sec-img">
        ...
        <div class="off-blue pb-5">
            <div class="container">
                    ...
                    <select id="country-select" class="form-select" aria-label="Default select example">
                        @if (isset($country))
                            @foreach ($countryList as $countryEl)
                                <option value="{{ $countryEl->id }}" @if ($countryEl->id === $country->id) selected @endif>
                                    {{ __('countries.' . $countryEl->name) }}</option>
                            @endforeach
                        @else
                ...
                @if (isset($country))
                    <div class="shadow">
                        <!---acordions-->
                        <div class="accordion d-sm-block d-md-block d-lg-block d-xl-none d-xxl-none"
                            id="accordionPanelsStayOpenExample">
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                    <a href="#"
                                        class="accordion-button @if ($tab == '1') show active @else collapsed @endif"
                                        type="button" data-bs-toggle="collapse"
                                        data-bs-target="#panelsStayOpen-collapseOne"
                                        aria-expanded="@if ($tab == '1') true @else false @endif"
                                        aria-controls="panelsStayOpen-collapseOne">
                                        {{ __('dynamic.content.profile') }}
                                    </a>
                                </h2>
                                <div id="panelsStayOpen-collapseOne"
                                    class="accordion-collapse collapse @if ($tab == '1') show @endif"
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                    <a href="#"
                                        class="accordion-button @if ($tab == '2') show active @else collapsed @endif"
                                        type="button" data-bs-toggle="collapse"
                                        data-bs-target="#panelsStayOpen-collapseTwo"
                                        aria-expanded="@if ($tab == '2') true @else false @endif"
                                        aria-controls="panelsStayOpen-collapseTwo">
                                        {{ __('dynamic.content.components') }}
                                    </a>
                                </h2>
                                <div id="panelsStayOpen-collapseTwo"
                                    class="accordion-collapse collapse @if ($tab == '2') show @endif"
                                    aria-labelledby="panelsStayOpen-headingTwo">
                                    <div class="accordion-body">
                                        @include('component.tab-pane-components', [
                                            'chart_id' => 'chart-accordion',
                                        ])
                                    </div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                    <a href="#"
                                        class="accordion-button @if ($tab == '3') show active @else collapsed @endif"
                                        type="button" data-bs-toggle="collapse"
                                        data-bs-target="#panelsStayOpen-collapseThree"
                                        aria-expanded="@if ($tab == '3') true @else false @endif"
                                        aria-controls="panelsStayOpen-collapseThree">
                                        {{ __('dynamic.content.impact') }}
                                    </a>
                                </h2>
                                <div id="panelsStayOpen-collapseThree"
                                    class="accordion-collapse collapse @if ($tab == '3') show @endif"
                                    aria-labelledby="panelsStayOpen-headingThree">
                                    <div class="accordion-body">
                                        @include('component.tab-pane-impact', [
                                            'chart_id' => 'chart-accordion',
                                        ])
                                    </div>
                                </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="panelsStayOpen-headingFour">
                                    <a href="#"
                                        class="accordion-button @if ($tab == '4') show active @else collapsed @endif"
                                        type="button" data-bs-toggle="collapse"
                                        data-bs-target="#panelsStayOpen-collapseFour"
                                        aria-expanded="@if ($tab == '4') true @else false @endif"
                                        aria-controls="panelsStayOpen-collapseFour">
                                        {{ __('dynamic.content.ghg') }}
                                    </a>
                                </h2>
                                <div id="panelsStayOpen-collapseFour"
                                    class="accordion-collapse collapse @if ($tab == '4') show @endif"
                                    aria-labelledby="panelsStayOpen-headingFour">
                                    <div class="accordion-body">
                                        @include('component.tab-pane-ghg', [
                                            'chart_id' => 'chart-accordion',
                                        ])
                                    </div>
                                </div>
                        ...
                        <div class="d-none d-sm-none d-md-none d-lg-none d-xl-block d-xxl-block">
                            <ul class="nav nav-tabs d-flex " id="myTab" role="tablist">
                                <li class="nav-item col-3" role="presentation">
                                    <span class="nav-link-3 @if ($tab == '1') active @endif oswald"
                                        id="tab-1" data-bs-toggle="tab" data-bs-target="#tab1" type="span"
                                ...
                                <li class="nav-item col-3" role="presentation">
                                    ...
                                    <div id="content" class="site-content">
                                        ...
                                        <div class="modal fade" id="modalGasolineEthanolBlending" data-keyboard="false"
                                            tabindex="-1" aria-labelledby="modalGasolineEthanolBlendingLabel">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <p> {{ __('dynamic.content.component-tab.modal-price-update') }}
                                                            <span class="text-underline-blue"><a
                                                                    href="https://grains.org/ethanol_report/"
                                                                    target="_blank">{{ __('dynamic.content.component-tab.modal-price-update-link') }}</a></span>
                                                        </p>

                                                        <form id="price-update-form" method="post"
                                                            action="{{ route('price-update-get-results') }}">


                                                            <div class="form-group row">
                                                                <span class="col-sm-8 col-input-group-text"
                                                                    id="basic-addon1">{{ __('dynamic.content.component-tab.modal-price-update-fuel-component') }}</span>
                                                                <span class="col-sm-4 col-input-group-text"
                                                                    id="basic-addon1">{{ __('dynamic.content.component-tab.modal-price-update-price') }}</span>
                                                            </div>

                                                            <div class="form-group row">
                                                                <label for="price_gasoline_regular"
                                                                    class="col-sm-8 col-form-label">{{ __('dynamic.content.component-tab.modal-price-update-gasoline-regular') }}</label>
                                                                <div class="col-sm-4">
                                                                    <input type="text" class="form-control-sm"
                                                                        id="price_gasoline_regular"
                                                                        aria-label="price_gasoline_regular"
                                                                        aria-describedby="price_gasoline_regular"
                                                                        required="True">
                                                                </div>
                                                            </div>

                                                            <div class="form-group row">
                                                                <label for="price_gasoline_premium"
                                                                    class="col-sm-8 col-form-label">{{ __('dynamic.content.component-tab.modal-price-update-gasoline-premium') }}</label>
                                                                <div class="col-sm-4">
                                                                    <input type="text" class="form-control"
                                                                        id="price_gasoline_premium"
                                                                        aria-label="price_gasoline_premium"
                                                                        aria-describedby="price_gasoline_premium"
                                                                        required="True">
                                                                </div>
                                                            </div>

                                                            <div class="form-group row">
                                                                <label for="price_normal_butane"
                                                                    class="col-sm-8 col-form-label">{{ __('dynamic.content.component-tab.modal-price-update-normal-butane') }}</label>
                                                                <div class="col-sm-4">
                                                                    <input type="text" class="form-control"
                                                                        id="price_normal_butane"
                                                                        aria-label="price_normal_butane"
                                                                        aria-describedby="price_normal_butane"
                                                                        required="True">
                                                                </div>
                                                            </div>

                                                            <div class="form-group row">
                                                                <label for="price_ethanol"
                                                                    class="col-sm-8 col-form-label">{{ __('dynamic.content.component-tab.modal-price-update-ethanol') }}</label>
                                                                <div class="col-sm-4">
                                                                    <input type="text" class="form-control"
                                                                        id="price_ethanol" aria-label="price_ethanol"
                                                                        aria-describedby="price_ethanol" required="True">
                                                                </div>
                                                            </div>

                                                            <div class="form-group row">
                                                                <label for="price_mtbe"
                                                                    class="col-sm-8 col-form-label">{{ __('dynamic.content.component-tab.modal-price-update-mtbe') }}</label>
                                                                <div class="col-sm-4">
                                                                    <input type="text" class="form-control"
                                                                        id="price_mtbe" aria-label="price_mtbe"
                                                                        aria-describedby="price_mtbe" required="True">
                                                                </div>
                                                            </div>

                                                            <div class="form-group row">
                                                                <label for="price_btx_weighted"
                                                                    class="col-sm-8 col-form-label">{{ __('dynamic.content.component-tab.modal-price-update-btx-weighted') }}</label>
                                                                <div class="col-sm-4">
                                                                    <input type="text" class="form-control"
                                                                        id="price_btx_weighted"
                                                                        aria-label="price_btx_weighted"
                                                                        aria-describedby="price_btx_weighted"
                                                                        required="True">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="d-flex justify-content-center pt-4">
                                                                <button id="modal-price-update-continue" type="submit"
                                                                    class="btn btn-primary px-4 oswald">{{ __('dynamic.content.component-tab.modal-price-update-continue') }}</button>
                                                            </div>
                                        ...
                                        <div class="modal fade" id="modalGasolineEthanolBlending_2" data-keyboard="false"
                                            tabindex="-1" aria-labelledby="modalGasolineEthanolBlendingLabel_2"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">
                                                            {{ __('dynamic.content.component-tab.modal-price-update-report-text') }}
                                                        </h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close">X</button>
                                                    </div>
                                                            ...
                                                            <table class="table-bordered" border="1" cellpadding="0"
                                                                ...
                                                                <thead>
                                                                    <tr class="table-titles ">
                                                                        <th colspan="2" id="th_country_text"
                                                                            scope="col">
                                                                            {{ __('countries.' . $country->name) }} </th>
                                                                        <th colspan="6" style="text-align:center"
                                                                            id="th_gasoline_text" scope="col">
                                                                            {{ __('dynamic.content.component-tab.constant-octane-number') }}
                                                                        </th>
                                                                    </tr>
                                                                    <tr class="table-titles ">
                                                                        <th id="th_price_text" scope="col">
                                                                            {{ __('dynamic.content.component-tab.prices') }}
                                                                        </th>
                                                                        <th id="th_gasoline_text" scope="col">
                                                                            {{ __('dynamic.content.component-tab.modal-price-update-gasoline') }}
                                                                        </th>
                                                                        <th id="th_gasoline_e0_text" scope="col">
                                                                            {{ __('dynamic.content.component-tab.modal-price-update-gasoline-e0') }}
                                                                        </th>
                                                                        <th id="th_gasoline_e10_text" scope="col">
                                                                            {{ __('dynamic.content.component-tab.modal-price-update-gasoline-e10') }}
                                                                        </th>
                                                                        <th id="th_gasoline_e15_text" scope="col">
                                                                            {{ __('dynamic.content.component-tab.modal-price-update-gasoline-e15') }}
                                                                        </th>
                                                                        <th id="th_gasoline_e20_text" scope="col">
                                                                            {{ __('dynamic.content.component-tab.modal-price-update-gasoline-e20') }}
                                                                        </th>
                                                                        <th id="th_gasoline_e25_text" scope="col">
                                                                            {{ __('dynamic.content.component-tab.modal-price-update-gasoline-e25') }}
                                                                        </th>
                                                                        <th id="th_gasoline_e30_text" scope="col">
                                                                            {{ __('dynamic.content.component-tab.modal-price-update-gasoline-e30') }}
                                                                        </th>
                                                                    </tr>
                                                                </thead>

                                                                <tbody class="table-bordered"
                                                                    id="table-data-constant-octane">
                                                            ...
                                                            <table class="table-bordered" border="1" cellpadding="0"
                                                                ...
                                                                <thead>
                                                                    <tr class="table-titles ">
                                                                        ...
                                                                        <th colspan="6" style="text-align:center"
                                                                            id="th_gasoline_text" scope="col">
                                                                            {{ __('dynamic.content.component-tab.increased-octane-number') }}
                                                                        </th>
                                                                    </tr>
                                                                    <tr class="table-titles ">
                                                                        <th scope="col">
                                                                ...
                                                                <tbody class="table-bordered"
                                                                    id="table-data-increased-octane">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center w-100">
                                                        <p> </p>
                                                        <button class="btn btn-primary px-4 oswald"
                                                            data-bs-target="#modalGasolineEthanolBlending"
                                                            data-bs-toggle="modal">{{ __('dynamic.content.component-tab.modal-price-update-go-back') }}</button>
                                                        <button id="modal-price-update-download" type="submit"
                                                            class="btn btn-primary px-4 oswald">{{ __('dynamic.content.profile-tab.download-button') }}</button>
                                                        <button class="btn btn-primary px-4 oswald"
                                                            data-bs-dismiss="modal">{{ __('dynamic.content.component-tab.modal-price-update-close') }}</button>
                                                        </br>
                                                    </div>
                                    ...
                                    <span class="nav-link-3 @if ($tab == '2') active @endif oswald"
                                        id="tab-2" data-bs-toggle="tab" data-bs-target="#tab2" type="span"
                                        role="tab" aria-controls="profile"
                                ...
                                <li class="nav-item col-3" role="presentation">
                                    <span class="nav-link-3 @if ($tab == '3') active @endif oswald"
                                        id="tab-3" data-bs-toggle="tab" data-bs-target="#tab3" type="span"
                                        role="tab" aria-controls="profile"
                                ...
                                <li class="nav-item col-3" role="presentation">
                                    <span class="nav-link-3 @if ($tab == '4') active @endif oswald"
                                        id="tab-4" data-bs-toggle="tab" data-bs-target="#tab4" type="span"
                                        role="tab" aria-controls="profile"
                            ...
                            <div class="tab-content off-white" id="myTabContent">
                                <div class="tab-pane fade @if ($tab == '1') show active @endif"
                                    id="tab1" role="tabpanel" aria-labelledby="tab-1">
                                    @include('component.tab-pane-profile')
                                </div>
                                <div class="tab-pane fade @if ($tab == '2') show active @endif"
                                    id="tab2" role="tabpanel" aria-labelledby="tab-2">
                                    @include('component.tab-pane-components', ['chart_id' => 'chart-tab'])
                                </div>
                                <div class="tab-pane fade @if ($tab == '3') show active @endif"
                                    id="tab3" role="tabpanel" aria-labelledby="tab-3">
                                    @include('component.tab-pane-impact', ['chart_id' => 'chart-tab'])
                                </div>
                                <div class="tab-pane fade @if ($tab == '4') show active @endif"
                                    id="tab4" role="tabpanel" aria-labelledby="tab-4">
                        ...
                        <aside role="complementary" aria-label="Footer" class="widget-area">
                            ...
                            <section id="custom_html-2" class="widget_text widget widget_custom_html">
                                ...
                                <div class="textwidget custom-html-widget">
                                    ...
                                    <p>
                                        <a href="https://grains.org/privacy/">{{ __('main.footer.privacy-policy') }}</a> |
                                        <a href="https://grains.org/cookies/">{{ __('main.footer.cookies-policy') }}</a> |
                                        <a href="https://grains.org/employment/">{{ __('main.footer.eeo-policy') }}</a> |
                                        <a
